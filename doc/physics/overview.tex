...
\begin{document}
    ...
    The first point of contact happened in the past, so $\Delta t \overset{!}{<} 0$, so select the solution with $- \sqrt{\dots}$. Move the circle by $\Delta t$. Now, the contact normal is given by the vector 
