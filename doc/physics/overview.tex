...
\begin{document}
	...
	\end{align*}
	With $v_x < 0 \Rightarrow \Delta t < 0$. $\Delta t$ gives how long ago the circle started colliding with the wall.
	\begin{align*}
	...
	\end{align*}
	$\vec{v}'$ and $\Delta \vec{r}$ as above. Note that because $v_x > 0$ for a collision with the right wall, we had to negate the result for $\Delta t$. 
