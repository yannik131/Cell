...
{
    const double eductMass = educt1_.getMass() + (educt2_.has_value() ? educt2_->getMass() : 0);
    const double productMass = product1_.getMass() + (product2_.has_value() ? product2_->getMass() : 0);
