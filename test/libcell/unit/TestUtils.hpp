...
inline auto getDefaultReactions()
{
    ...
    cell::Reaction decomposition{Mass10, std::nullopt, Mass5, Mass5, 1.};
    cell::Reaction combination{Mass5, Mass5, Mass10, std::nullopt, 1.};
    cell::Reaction exchange{Mass5, Mass15, Mass10, Mass10, 1.};
